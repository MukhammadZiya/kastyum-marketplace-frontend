...
export const menuData: MenuItem[] = [
  ...
  },
  {
    ...
    path: "/",
    submenu: [
      { id: 61, title: "Shop With Sidebar", newTab: false, path: "/shop-with-sidebar" },
      ...
      { id: 69, title: "My Account", newTab: false, path: "/my-account" },
      { id: 70, title: "Contact", newTab: false, path: "/contact" },
      { id: 63, title: "Error", newTab: false, path: "/error" },
      { id: 64, title: "Mail Success", newTab: false, path: "/mail-success" },
    ],
  },
  {
    id: 7,
    ...
    submenu: [
      ...
      { id: 72, title: "Blog Grid", newTab: false, path: "/blogs/blog-grid" },
      {
        id: 73,
      ...
      { id: 74, title: "Blog details", newTab: false, path: "/blogs/blog-details" },
    ],
  },
];
