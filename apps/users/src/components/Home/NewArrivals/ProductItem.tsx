  ...
  return (
    <article className="group relative overflow-hidden rounded-xl bg-white shadow-[0_14px_54px_-48px_rgba(15,23,42,0.6)] ring-1 ring-neutral-100 transition duration-200 ease-out hover:-translate-y-0.5 hover:shadow-[0_24px_72px_-52px_rgba(15,23,42,0.7)]">
      <div className="relative aspect-[5/6] w-full overflow-hidden bg-[#FAFAFB]">
        ...
        <div className="pointer-events-none absolute inset-0 z-10 bg-neutral-950/0 transition duration-200 sm:group-hover:bg-neutral-950/30" />
        <div className="pointer-events-none absolute inset-x-0 bottom-0 z-20 flex items-center justify-center gap-2 p-3 opacity-100 transition duration-200 ease-out sm:opacity-0 sm:group-hover:opacity-100">
          <button
