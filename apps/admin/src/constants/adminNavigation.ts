export type AdminNavId = "users" | "sellers" | "products" | "orders" | "categories" | "search";
...
export const ADMIN_NAV_ITEMS: AdminNavItem[] = [
  ...
  { id: "categories", labelKey: "common.adminNavCategories", path: "/categories" },
...
export const ADMIN_PAGE_TITLE_KEYS: Record<AdminNavId, string> = {
  ...
  categories: "common.adminPageCategories",
